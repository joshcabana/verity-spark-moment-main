...
Be conservative. Passionate discussion ≠ aggression. Respond using the moderate_audio tool.`,
              },
              {
                ...
                content: [
                  {
                    type: "text",
                    text: `Analyze this audio clip from a video call for safety violations. The audio data (base64 webm) is provided for reference. Transcribe what you can and assess tone/content for the categories below. Audio payload length: ${audioBase64.length} chars.`,
                  },
                ],
              },
            ],
